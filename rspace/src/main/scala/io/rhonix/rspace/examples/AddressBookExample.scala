package io.rhonix.rspace.examples
...
import io.rhonix.rspace.util.{runKs, unpackOption, unpackSeq}
import io.rhonix.rspace.{RSpace, _}
import io.rhonix.shared.Language.ignore
...
object AddressBookExample {
  ...
  object implicits {
    ...
    implicit val concurrentF: Concurrent[Id] = io.rhonix.catscontrib.effect.implicits.concurrentId
