...
import io.rhonix.rspace.history.History._
import io.rhonix.rspace.internal._
import io.rhonix.rspace.test._
import io.rhonix.rspace.trace.Consume
import io.rhonix.rspace.util.{getK, runK, unpackOption}
...
trait StorageActionsTests[F[_]]
  ...
  implicit val serializeString: Serialize[String] = io.rhonix.rspace.util.stringSerialize
