...
import io.rhonix.shared.syntax.{sharedSyntaxKeyValueStore, sharedSyntaxKeyValueTypedStore}
import io.rhonix.store.{InMemoryKeyValueStore, KeyValueTypedStore}
...
class RadixTreeSpec extends AnyFlatSpec with Matchers with OptionValues {
  ...
  "function commonPrefix" should "return correct prefixes" in {
    import io.rhonix.rspace.history.KeySegment._
