...
/**
  ...
  * by ["findOrCreate" rholang term](https://github.com/rchain/pyrhonix/blob/master/rhonix/vault.py#L18-L29)
...
object MergeBalanceMain {
  ...
  def getBalanceFromRholang[F[_]: Sync: Span: Log](
    ...
    for {
      ...
      balance = result.head.exprs.head.exprInstance.gInt.getOrElse(0L)
