...
import io.rhonix.rspace.history.RadixTree.ExportData
import io.rhonix.rspace.history._
import io.rhonix.rspace.history.instances._
import io.rhonix.shared.syntax._
import io.rhonix.shared.{Base16, Log, Stopwatch}
import io.rhonix.store.{InMemoryKeyValueStore, KeyValueStore, LmdbStoreManager}
  ...
  class Experiment[F[_]: Concurrent: ContextShift: Parallel: Log: Metrics: Span: Sync] {
    ...
    def experiment(numInit: Int, numInsReadDel: Int): F[Unit] = {
      ...
      def export(
        ...
        import io.rhonix.rspace.history.RadixTree._
