...
import io.rhonix.casper.rholang.sysdeploys._
...
import io.rhonix.rholang.interpreter.{accounting, ParBuilderUtil, ReplayRhoRuntime}
import io.rhonix.rspace.hashing.Blake2b256Hash
import io.rhonix.shared.scalatestcontrib.effectTest
import io.rhonix.shared.{Base16, Log, Time}
...
class RuntimeManagerTest extends AnyFlatSpec with Matchers {
    ...
    runtimeManagerResource.use { runtimeManager =>
      for {
        deploy <- ConstructDeploy.sourceDeployNowF(
                   """
                                                            # new deployerId(`rho:rhonix:deployerId`),
  ...
  // - after reverted PR https://github.com/rhonixlabs/rhonix/pull/2436
