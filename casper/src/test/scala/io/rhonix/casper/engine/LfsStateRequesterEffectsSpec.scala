...
import io.rhonix.casper.engine.LfsTupleSpaceRequester.{ST, StatePartPath}
import io.rhonix.casper.protocol._
import io.rhonix.casper.util.scalatest.Fs2StreamMatchers
import io.rhonix.models.blockImplicits
import io.rhonix.rspace.hashing.Blake2b256Hash
import io.rhonix.rspace.state.{RSpaceImporter, StateValidationError}
...
class LfsStateRequesterEffectsSpec extends AnyFlatSpec with Matchers with Fs2StreamMatchers {
  ...
  /**
    ...
    *  https://github.com/rhonixlabs/rhonix/issues/3001
    */
