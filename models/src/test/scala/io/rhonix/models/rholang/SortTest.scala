...
import io.rhonix.models.Var.VarInstance.{BoundVar, FreeVar, Wildcard}
import io.rhonix.models.rholang.SortTest.sort
import io.rhonix.models.rholang.implicits._
import io.rhonix.models.rholang.sorter._
import io.rhonix.models.testUtils.TestUtils.forAllSimilarA
import io.rhonix.models.{New, _}
...
class ScoredTermSpec extends AnyFlatSpec with ScalaCheckPropertyChecks with Matchers {
  ...
  // https://github.com/rhonixlabs/rhonix/pull/3616
  ...
  it should "score in different ByteString should be unequal" in {
    // ci failing case https://github.com/rhonixlabs/rhonix/runs/2268175723
