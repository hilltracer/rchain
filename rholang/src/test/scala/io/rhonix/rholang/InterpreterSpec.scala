...
import io.rhonix.models.{Expr, Par}
...
import io.rhonix.rholang.interpreter.{EvaluateResult, RhoRuntime}
...
class InterpreterSpec extends AnyFlatSpec with Matchers {
  ...
  it should "signal syntax errors to the caller" in {
    ...
    errors(0) shouldBe a[io.rhonix.rholang.interpreter.errors.SyntaxError]
  }
